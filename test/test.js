...
describe('#timeago', function() {
    ...
    it('Should hanlde when now date is less than entered date in future  (now - 4 years)', function() {
        var result = timeago.simple(DateCalc(946708560000));
        expect(result).to.equal('31 years ago');
    });
});
